            ...
            <div class="grid columns-2 gap-4">
                ...
                <div class="g-col-2 g-col-xl-1 d-none d-xl-flex flex-column min-vh-screen">
                    <a href="login-light-login.html" class="-intro-x d-flex align-items-center pt-5">
                        <img alt="Rubick Bootstrap HTML Admin Template" class="" src="{{asset('frontend/images/logo.webp')}}">
                    </a>
                    <div class="my-auto">
                        <img alt="Rubick Bootstrap HTML Admin Template" class="-intro-x mt-n16" src="{{asset('frontend/images/logo.webp')}}">
