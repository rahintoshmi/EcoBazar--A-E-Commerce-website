                            ...
                            <div class="g-col-12 g-col-xl-4 mt-6">
                                ...
                                <div class="mt-5">
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-8.jpg')}}">
                                            </div>
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-11.jpg')}}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-7.jpg')}}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-4.jpg')}}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-8.jpg')}}" title="Uploaded at 16 July 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-3.jpg')}}" title="Uploaded at 14 September 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-14.jpg')}}" title="Uploaded at 7 August 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-2.jpg')}}" title="Uploaded at 15 January 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-5.jpg')}}" title="Uploaded at 16 January 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-9.jpg')}}" title="Uploaded at 22 July 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-13.jpg')}}" title="Uploaded at 7 July 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-6.jpg')}}" title="Uploaded at 7 December 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-1.jpg')}}" title="Uploaded at 13 February 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-3.jpg')}}" title="Uploaded at 19 September 2020">
                                                        </div>.jpg
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-3.jpg')}}" title="Uploaded at 21 May 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{asset('backend/images/preview-1.jpg')}}" title="Uploaded at 30 December 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="g-col-12 g-col-md-6 g-col-xl-4 g-col-xxl-12 mt-3 mt-xxl-8">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="intro-x">
                                            <div class="box px-5 py-3 mb-3 d-flex align-items-center zoom-in">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-15.jpg')}}">
                                                </div>
                                                <div class="ms-4 me-auto">
                                    ...
                                    <div class="report-timeline mt-5 position-relative">
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-14.jpg')}}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{asset('backend/images/profile-6.jpg')}}">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                                <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-gray-600">
                                                    ...
                                                    <div class="d-flex mt-2">
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Sony Master Series A9G">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{asset('backend/images/preview-2.jpg')}}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Dell XPS 13">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{asset('backend/images/preview-10.jpg')}}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Nikon Z6">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{asset('backend/images/preview-9.jpg')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
