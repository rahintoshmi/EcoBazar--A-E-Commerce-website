...
<head>
    ...
    <link rel="shortcut icon" href="./images/faviIcon.png" type="image/x-icon" />
        ...
        <main>
            <section id="wishlist">
                ...
                <tr>
                  ...
                  <td><h6 class="price">$14.00 <del>$20.99</del></h6></td>
                  <td>
                     <a href="#" class="instock">In Stock</a>
                  </td>
                  <td>
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-6 d-flex"> <a href="./shopping_cart.html" class="cart">Add to Cart</a></div>
                        <div class="col-6 d-flex"><a href="#" class="cross"><i class="fa-solid fa-xmark"></i></a></div>
                    </div>
                ...
                <tr>
                  <td>
                    <div class="row">
                        <div class="col-md-4"> <img src="./images/wishlistcabbage.png" class="img-fluid" alt="" /></div>
                        <div class="col-md-8"><h3>Chinese Cabbage</h3></div>
                    </div>
                  </td>
                  <td><h6 class="price">$45.00</h6></td>
                  <td>
                     <a href="#"  class="instock">In Stock</a>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="row">
                        <div class="col-md-4"> <img src="./images/wishlist mango.png" class="img-fluid" alt="" /></div>
                        <div class="col-md-8"><h3>Fresh Sujapuri Mango</h3></div>
                    </div>
                  </td>
                  <td><h6 class="price">$09.00</h6></td>
                  <td>
                     <a href="#" class="outstock">Out of Stock</a>
                  </td>
                  <td>
                    <div class="row d-flex">
                        <div class="col-6 d-flex"> <a href="./shopping_cart.html" class="cart1">Add to Cart</a></div>
                        <div class="col-6 d-flex"><a href="#" class="cross"><i class="fa-solid fa-xmark"></i></a></div>
                    </div>
                ...
                <tr>
                    <td colspan="2">
                        <div class="row d-flex">
                            <div class="col-2 d-flex"><h3  class="share">Share:</h3></div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-2 me-2">
                                <a href="#"><img src="./images/Method=ApplePay.png" alt="" /></a>
                            </div>
                            <div class="col-2 me-2">
                                <a href="#"><img src="./images/Method=Visa.png" alt="" /></a>
                            </div>
                            <div class="col-2 me-2">
                                <a href="#"><img src="./images/Method=Discover.png" alt="" /></a>
                            </div>
                            <div class="col-2 me-2">
                                <a href="#"><img src="./images/Method=Mastercard.png" alt="" /></a>
                            </div>
                            <div class="col-2">
