...
<section id="mobileSidemenuShop" class="d-lg-none">
  ...
  <!-- Logo -->
  <a href="./index.html">
    <img src="{{asset('frontend/images/logo.png')}}" alt="Logo" style="height: 40px;" />
  </a>
    ...
    <i class="fa-solid fa-xmark"></i>
          ...
          <div class="offcanvas-body">
            ...
            <div class="shopBanner">
              <img src="{{asset('frontend/images/shopBanner.png')}}" class="img-fluid" alt="" />
            </div>
            <h6>Sale Products</h6>
            <div class="card mt-4">
              <div class="card-body">
            ...
            <div class="card mt-4">
              <div class="card-body">
                <div class="row align-items-center">
                  <div class="col-4 CardImg1">
                    <a href="#"
                      ><img src="{{asset('frontend/images/shopMango.png')}}" alt="Green Apple"
                    /></a>
                  </div>
                  <div class="col-8 CardCnt1">
            ...
            <div class="col-lg-6">
              <div class="row">
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="{{asset('frontend/images/Method=ApplePay.')}}" alt=""
                  /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"><img src="{{asset('frontend/images/Method=Visa.')}}" alt="" /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="{{asset('frontend/images/Method=Discover.')}}" alt=""
                  /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="{{asset('frontend/images/Method=Mastercard.')}}" alt=""
                  /></a>
                </div>
                <div class="col-2">
                  <a href="#"><img src="{{asset('frontend/images/Cart.')}}" alt="" /></a>
                </div>
              </div>
            </div>
          </div>
